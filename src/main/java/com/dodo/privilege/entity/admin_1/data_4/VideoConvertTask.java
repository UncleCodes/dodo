...
@DodoMenu(nameKey = "dodo.privilege.admin.data.VideoConvertTask.menuNameKey", level = DodoMenuLevel.LEVEL3, sortSeq = 6)
@DodoRight(nameKey = "dodo.privilege.admin.data.VideoConvertTask.entityKey")
@DodoCodeGenerator(daoGenerator = @DodoDaoGenerator, srvGenerator = @DodoSrvGenerator, actGenerator = @DodoActionGenerator(actions = {
        DodoAction.VIEW, DodoAction.EXPORT, DodoAction.CHART, DodoAction.DELETE }))
