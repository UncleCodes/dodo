...
@Entity
@DynamicInsert
@DodoEntity(nameKey = "dodo.privilege.admin.videoad.VideoPreVideoAd.entityKey", actions = { DodoAction.ALL })
@DodoMenus(levelOne = @DodoMenu(nameKey = "dodo.privilege.admin.menuNameKey", sortSeq = 1), levelTwo = @DodoMenu(nameKey = "dodo.privilege.admin.videoad.menuNameKey", sortSeq = 3), levelThree = @DodoMenu(nameKey = "dodo.privilege.admin.videoad.VideoPreVideoAd.menuNameKey", sortSeq = 1))
