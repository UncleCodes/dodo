...
@DodoMenu(nameKey = "dodo.privilege.admin.base.Role.menuNameKey", level = DodoMenuLevel.LEVEL3, sortSeq = 2)
@DodoRight(nameKey = "dodo.privilege.admin.base.Role.entityKey")
