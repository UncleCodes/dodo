...
@DynamicInsert
@DodoEntity(
        nameKey = "dodo.privilege.admin.data.FreeStateFile.entityKey",
        ...
        levelThree = @DodoMenu(nameKey = "dodo.privilege.admin.data.FreeStateFile.menuNameKey", sortSeq = 4))
public class FreeStateFile extends BaseEntity {
    private static final long serialVersionUID = -4838958645030206041L;

    @DodoField(
            sortSeq = 0,
            nameKey = "dodo.privilege.admin.data.FreeStateFile.namekey.entityClassName",
            addable = false,
            editable = false,
            queryOnList = true)
    ...
    @DodoField(
            sortSeq = 1,
            nameKey = "dodo.privilege.admin.data.FreeStateFile.namekey.entityName",
            addable = false,
            editable = false,
            queryOnList = true)
    ...
    @DodoField(
            sortSeq = 2,
            nameKey = "dodo.privilege.admin.data.FreeStateFile.namekey.entityId",
            addable = false,
            editable = false,
            queryOnList = true)
    ...
    @DodoField(
            sortSeq = 3,
            nameKey = "dodo.privilege.admin.data.FreeStateFile.namekey.fieldName",
            addable = false,
            editable = false,
            queryOnList = true)
    ...
    @DodoField(
            sortSeq = 4,
            nameKey = "dodo.privilege.admin.data.FreeStateFile.namekey.fieldShowName",
            addable = false,
            editable = false,
            queryOnList = true)
    ...
    @DodoField(
            sortSeq = 5,
            nameKey = "dodo.privilege.admin.data.FreeStateFile.namekey.extFieldName",
            addable = false,
            editable = false)
    ...
    @DodoField(
            sortSeq = 6,
            nameKey = "dodo.privilege.admin.data.FreeStateFile.namekey.extFieldShowName",
            addable = false,
            editable = false)
    ...
    @DodoField(
            sortSeq = 7,
            nameKey = "dodo.privilege.admin.data.FreeStateFile.namekey.fileStr",
            addable = false,
            editable = false,
            isFile = true)
    ...
    @DodoField(
            sortSeq = 8,
            nameKey = "dodo.privilege.admin.data.FreeStateFile.namekey.videoFileStr",
            addable = false,
            editable = false,
            isVideo = true)
    ...
    @DodoField(
            sortSeq = 9,
            nameKey = "dodo.privilege.admin.data.FreeStateFile.namekey.ossBucket",
            addable = false,
            editable = false)
