...
@DodoMenu(nameKey = "dodo.privilege.admin.videoad.VideoAfterAd.menuNameKey", level = DodoMenuLevel.LEVEL3, sortSeq = 5)
@DodoRight(nameKey = "dodo.privilege.admin.videoad.VideoAfterAd.entityKey")
