...
@DodoMenu(nameKey = "dodo.privilege.admin.config.MenuInfo.menuNameKey", level = DodoMenuLevel.LEVEL3, sortSeq = 1)
@DodoRight(nameKey = "dodo.privilege.admin.config.MenuInfo.entityKey")
