...
@DodoMenu(nameKey = "dodo.privilege.admin.data.BreakPointInfo.menuNameKey", level = DodoMenuLevel.LEVEL3, sortSeq = 3)
@DodoRight(nameKey = "dodo.privilege.admin.data.BreakPointInfo.entityKey")
