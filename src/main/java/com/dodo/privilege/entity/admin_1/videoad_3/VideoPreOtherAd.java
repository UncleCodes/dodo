...
@DodoMenu(nameKey = "dodo.privilege.admin.videoad.VideoPreOtherAd.menuNameKey", level = DodoMenuLevel.LEVEL3, sortSeq = 2)
@DodoRight(nameKey = "dodo.privilege.admin.videoad.VideoPreOtherAd.entityKey")
