...
@DodoEntity(nameKey = "dodo.privilege.admin.config.Field.entityKey", actions = { DodoAction.VIEW, DodoAction.CHART,
        DodoAction.EXPORT })
@DodoMenus(levelOne = @DodoMenu(nameKey = "dodo.privilege.admin.menuNameKey", sortSeq = 1), levelTwo = @DodoMenu(nameKey = "dodo.privilege.admin.config.menuNameKey", sortSeq = 5), levelThree = @DodoMenu(nameKey = "dodo.privilege.admin.config.Field.menuNameKey", sortSeq = 4))
