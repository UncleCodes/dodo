...
@DodoMenu(nameKey = "dodo.privilege.admin.config.Field.menuNameKey", level = DodoMenuLevel.LEVEL3, sortSeq = 4)
@DodoRight(nameKey = "dodo.privilege.admin.config.Field.entityKey")
