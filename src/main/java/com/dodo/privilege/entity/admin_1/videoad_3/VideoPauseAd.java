...
@DodoMenu(nameKey = "dodo.privilege.admin.videoad.VideoPauseAd.menuNameKey", level = DodoMenuLevel.LEVEL3, sortSeq = 3)
@DodoRight(nameKey = "dodo.privilege.admin.videoad.VideoPauseAd.entityKey")
