...
@Entity
@DynamicInsert
@DodoEntity(name = "添加和修改", actions = { DodoAction.ALL })
@DodoMenus(levelOne = @DodoMenu(name = "Demo系统", sortSeq = 7), levelTwo = @DodoMenu(name = "基础演示", sortSeq = 1), levelThree = @DodoMenu(name = "添加和修改演示", sortSeq = 4))
