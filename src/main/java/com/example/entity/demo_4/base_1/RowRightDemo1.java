...
@Entity
@DynamicInsert
@DodoEntity(name = "行级权限(只能操作自己添加的数据)", actions = { DodoAction.ALL })
@DodoMenus(levelOne = @DodoMenu(name = "Demo系统", sortSeq = 7), levelTwo = @DodoMenu(name = "基础演示", sortSeq = 1), levelThree = @DodoMenu(name = "行级权限演示(1)", sortSeq = 9))
