...
@Entity
@DynamicInsert
@DodoEntity(name = "分组视图", actions = { DodoAction.ALL }, levelOne = @DodoMenu(name = "Demo系统", sortSeq = 7), levelTwo = @DodoMenu(name = "基础演示", sortSeq = 1), levelThree = @DodoMenu(name = "分组视图演示", sortSeq = 12))
