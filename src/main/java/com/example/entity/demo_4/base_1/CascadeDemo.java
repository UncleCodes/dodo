...
@Entity
@DynamicInsert
@DodoEntity(name = "级联", actions = { DodoAction.ALL })
@DodoMenus(levelOne = @DodoMenu(name = "Demo系统", sortSeq = 7), levelTwo = @DodoMenu(name = "基础演示", sortSeq = 1), levelThree = @DodoMenu(name = "级联演示", sortSeq = 8))
